...
elseif (!empty($_POST))
{
//Заголовок письма для Вас
$headers  = "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: $content  charset=$charset\r\n";
$headers .= "Date: ".date("Y-m-d (H:i:s)",time())."\r\n";
$headers .= "From: \"Письмо с моего сайта от: ".$_POST['posName']."\" <".$_POST['posEmail'].">\r\n";
$headers .= "X-Mailer: My Send E-mail\r\n";

//Заголовок для дубликата письма отправителю
$headerszakaz  = "MIME-Version: 1.0\r\n";
$headerszakaz .= "Content-Type: $content  charset=$charset\r\n";
$headerszakaz .= "Date: ".date("Y-m-d (H:i:s)",time())."\r\n";
$headerszakaz .= "From: \"Вы отправили письмо\" <".$mailto.">\r\n";
$headerszakaz .= "X-Mailer: My Send E-mail\r\n";

mail("$mailto","$subject","$message","$headers");  //получаем письмо с сайта
mail($_POST['posEmail'],"$subject","Текст Вашего сообщения: $message","$headerszakaz");  //отправляем сообщение посетителю
